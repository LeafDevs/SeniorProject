...
public class HolyBoots{
    ...
    public HolyBoots() {
        this.armor = new Armor("Holy Boots", 125, 250, 0, 10, 1225, 300, 120, Rarity.BLESSED, new ItemStack(Material.IRON_BOOTS), ArmorType.BOOTS, "Boots that were blessed by", "the Almighty God");
    }
