...
public class KnightArcher extends PlayerEnemy {
    ...
    public Entity spawn(Location loc) {
        ...
        entity.setEquipment(
                new Equipment().setItem(new ItemStack(Material.BOW))
        );
        this.npc = entity;
